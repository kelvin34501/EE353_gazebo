...
namespace gazebo
{
    class WorldInit: public WorldPlugin {
        public: void Load(physics::WorldPtr _parent, sdf::ElementPtr) {
            ...
            // ========================================================================================================
            vector<vector<double>> robot_pos {
                {-1, 6, 0},
                {-2, 6, 0},
                {-3, 6, 0},
                {-4, 6, 0},
            ...
            for (const auto &pos: robot_pos) {
                ...
                sdf_ss << "        <pose>" << pos[0] << ' ' << pos[1] <<" 0 0 0 0</pose>\n";
                sdf_ss << "        <include><uri>model://robot_2</uri></include>\n";
                sdf_ss << "        <plugin name='velodyne_control' filename='libvelodyne_plugin.so'>\n";
                sdf_ss << "            <velocity>250.0</velocity>\n";
                sdf_ss << "        </plugin>\n";
                sdf_ss << "    </model>\n";
                sdf_ss << "</sdf>";
